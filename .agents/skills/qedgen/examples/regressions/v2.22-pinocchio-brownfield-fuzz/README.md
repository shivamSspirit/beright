...
```bash
qedgen probe --fuzz 0 --root examples/regressions/v2.22-pinocchio-brownfield-fuzz/buggy_pinocchio/
```
...
```bash
cp -r examples/regressions/v2.22-pinocchio-brownfield-fuzz/buggy_pinocchio /tmp/
