...
- Solana Kit (@solana/kit): [kit/overview.md](solana-references/kit/overview.md) — plugin clients, quick start, common patterns
- Kit Plugins & Composition: [kit/plugins.md](solana-references/kit/plugins.md) — ready-to-use clients, custom client composition, available plugins
- Kit Advanced: [kit/advanced.md](solana-references/kit/advanced.md) — manual transactions, direct RPC, building plugins, domain-specific clients
- UI + wallet + hooks: [frontend-framework-kit.md](solana-references/frontend-framework-kit.md)
- Kit ↔ web3.js boundary: [kit-web3-interop.md](solana-references/kit-web3-interop.md)
- Anchor programs: [programs-anchor.md](solana-references/programs-anchor.md)
- Pinocchio programs: [programs-pinocchio.md](solana-references/programs-pinocchio.md)
- Testing strategy: [testing.md](solana-references/testing.md)
- IDLs + codegen: [idl-codegen.md](solana-references/idl-codegen.md)
- Payments: [payments.md](solana-references/payments.md)
- Confidential transfers: [confidential-transfers.md](solana-references/confidential-transfers.md)
- Security checklist: [security.md](solana-references/security.md)
- Reference links: [resources.md](solana-references/resources.md)
- **Version compatibility:** [compatibility-matrix.md](solana-references/compatibility-matrix.md)
- **Common errors & fixes:** [common-errors.md](solana-references/common-errors.md)
- **Surfpool (local network):** [surfpool.md](solana-references/surfpool.md)
- **Surfpool cheatcodes:** [surfpool-cheatcodes.md](solana-references/surfpool-cheatcodes.md)