...
**NEW:** Compress your predictions and save 99.96% on storage costs!
...
// 1. Initialize tree (one-time, ~$0.56)
const tree = await initializeMerkleTree(program, payer, treeKeypair, authority, 14, 64);

// 2. Record predictions (99% cheaper!)
await recordCompressedPrediction(program, forecaster, tree, marketId, 0.75, 'Yes', memoSig, 0);
// Cost: $0.0001 (vs $0.27 for PDA) ✨
```

**📖 Full Guide:** [COMPRESSION_MIGRATION_GUIDE.md](./COMPRESSION_MIGRATION_GUIDE.md)
