...
pub struct ForecasterState {
    ...
    /// Legacy 1 SOL threshold is retained only for compatibility helpers.
...
impl ForecasterState {
    ...
    */
    ...
    /// Legacy compatibility check from the retired vault-access model.
    /// Not used by active BeRight product flows.
    ///
