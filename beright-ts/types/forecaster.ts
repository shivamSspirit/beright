...
// =============================================================================
// POOL TYPES (Meteora DAMM v2 + Sanctum)
// =============================================================================

/**
 * Forecast Pool - Created by eligible forecasters
 *
 * Uses Meteora DAMM v2 for the forecaster token pool.
 * Idle capital routed to Sanctum INF for yield.
 */
