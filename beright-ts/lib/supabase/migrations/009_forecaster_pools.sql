...
-- Description: Legacy tables for retired forecaster delegation pools
-- Created: 2026-03-21
-- Status: Historical schema only. Do not wire new product flows to these tables.

-- ============================================================================
-- FORECASTER POOLS
-- ============================================================================
-- Retained for historical deployments; active BeRight scope does not include
-- staking pool or capital delegation features.
