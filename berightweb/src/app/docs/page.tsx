    ...
    <div className="docs-page">
      ...
      <aside className={`docs-sidebar ${mobileMenuOpen ? 'open' : ''}`}>
        ...
        <div className="sidebar-cta">
          <a href="https://t.me/mygroupname" target="_blank" rel="noopener noreferrer" className="cta-btn">
            Try Telegram Bot →
          </a>
        </div>
      </aside>
      ...
      <main className="docs-main">
        ...
        {activeSection === 'current' && (
          <section className="content-section">
            ...
            <div className="try-cta">
              ...
              <a href="https://t.me/mygroupname" target="_blank" rel="noopener noreferrer" className="try-btn">
        ...
        {activeSection === 'telegram' && (
          <section className="content-section">
            ...
            <div className="telegram-cta">
              <a href="https://t.me/mygroupname" target="_blank" rel="noopener noreferrer" className="telegram-btn">
        ...
        <footer className="docs-footer">
          ...
          <div className="footer-links">
            <a href="https://t.me/mygroupname" target="_blank" rel="noopener noreferrer">Telegram</a>
