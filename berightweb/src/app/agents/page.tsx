...
const cognitiveLoopPhases = [
  { id: 'perceive', name: 'PERCEIVE', desc: 'Gather unprocessed signals from world state', icon: '👁️' },
  { id: 'beliefs', name: 'UPDATE BELIEFS', desc: 'Convert observations to confidence-scored beliefs', icon: '💭' },
  { id: 'evaluate', name: 'EVALUATE', desc: 'Analyze episodes, detect biases, extract lessons', icon: '⚖️' },
  { id: 'deliberate', name: 'DELIBERATE', desc: 'Create goals from high-priority events', icon: '🤔' },
  { id: 'plan', name: 'PLAN', desc: 'Create action plan with steps and preconditions', icon: '📋' },
  { id: 'act', name: 'ACT', desc: 'Execute plan, delegate to specialist agents', icon: '⚡' },
  { id: 'reflect', name: 'REFLECT', desc: 'Learn from outcomes, update calibration', icon: '🔄' }
];

const channels = [
  { name: 'Telegram', icon: '📱', status: 'gateway' },
  { name: 'WhatsApp', icon: '💬', status: 'gateway' },
  { name: 'Discord', icon: '🎮', status: 'gateway' },
  { name: 'Web Terminal', icon: '🖥️', status: 'gateway' },
  { name: 'iMessage', icon: '📲', status: 'gateway' },
];
        ...
        {selectedAgentData && (
          ...
          >
            <div className={styles.detailHeader}>
              <span className={styles.detailIcon}>{selectedAgentData.icon}</span>
              <div>
      ...
      <section className={styles.insightSection}>
        <div className={styles.insightBox}>
          ...
          <div className={styles.insightContent}>
            ...
            <p><strong>Telegram is not a product.</strong> It's just a channel.</p>
