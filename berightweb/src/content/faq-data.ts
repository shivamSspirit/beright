...
• **AI-powered forecasts** - Benchmark your predictions against our OpenClaw AI ensemble
...
Philip Tetlock's superforecasters typically achieve 0.10-0.15 on geopolitical questions.`,
  },
  {
    ...
    answer: `Every market on BeRight has an **AI probability forecast** generated by our OpenClaw AI multi-agent system.

**How it works:**
1. Scout agent scans market data and signals
2. Analyst agent applies superforecasting methodology
3. Generates a calibrated probability estimate with reasoning
4. Your predictions are compared against the AI's predictions
5. We track who performs better over time
...
• Qualifying to create Conviction Pools
• Attracting capital from delegators`,
  },
  {
...
**The Terminal will:**
1. Parse your intent using OpenClaw AI
2. Route to the appropriate agent (Scout, Analyst, Trader)
...
• **Private** - Invite-only
• **Institutional** - Large minimums, custom terms

**Safety features:**
• Funds held in on-chain Solana smart contracts
• Forecaster can only trade, not withdraw your funds
• Transparent on-chain performance history
• Withdrawal notice period for liquidity management`,
  },
  {
    id: 'delegation',
    category: 'Pools & Vaults',
...
• Solana liquid staking provides baseline returns
• Passive yield distributed proportionally to delegators

**Pool Capital Allocation:**
• ~40-60% actively traded on predictions
• ~30-40% in yield strategies (Sanctum INF)
• ~10-20% held as reserve (for withdrawals)
