    ...
    <section className="final-cta-section">
      ...
      <div className="final-cta-content">
        ...
        <div className="final-cta-buttons">
          ...
          <a href="https://t.me/beright" target="_blank" rel="noopener noreferrer" className="final-btn secondary">
    ...
    <section id="terminal" className="terminal-section" aria-labelledby="terminal-title">
      ...
      <div className="terminal-cta">
        ...
        <div className="cta-buttons">
          <a href="https://t.me/beright" className="terminal-btn telegram">
        ...
        <div className="hero-split">
          ...
          <div className="hero-left">
            ...
            <div className="hero-cta-row">
              ...
              <a href="https://t.me/beright" target="_blank" rel="noopener noreferrer" className="cta-button ghost">
