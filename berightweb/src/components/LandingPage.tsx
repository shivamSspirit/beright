    ...
    <nav className="fixed top-0 w-full z-50 border-b border-[var(--color-border)] bg-[var(--color-bg-base)]/90 backdrop-blur-xl">
      <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
        <div className="flex items-center gap-2 group cursor-pointer">
          <BrandLogo size={32} />
          <span className="font-semibold text-xl tracking-tight text-[var(--color-text-primary)] group-hover:text-[var(--color-primary)] transition-colors">
            BeRight
          </span>
        </div>
        ...
        <button
          onClick={login}
          disabled={!ready}
          className="flex items-center gap-2 bg-[var(--color-primary)] hover:bg-[var(--color-primary-hover)] px-5 py-2.5 rounded-full transition-all font-semibold text-sm text-[var(--color-bg-base)] disabled:opacity-50 cursor-pointer shadow-[var(--shadow-glow-primary)]"
        >
...
function LiveTicker() {
  ...
  return (
    <div className="mt-16 w-full border-b border-[var(--color-border)] bg-[var(--color-bg-surface-1)]/50 overflow-hidden relative">
      <div className="absolute top-0 left-0 w-24 h-full bg-gradient-to-r from-[var(--color-bg-base)] to-transparent z-10" />
      <div className="absolute top-0 right-0 w-24 h-full bg-gradient-to-l from-[var(--color-bg-base)] to-transparent z-10" />

      <div className="flex whitespace-nowrap py-3 animate-marquee hover:[animation-play-state:paused]">
        <div className="flex gap-10 px-4 font-mono text-xs items-center">
...
function HeroSection() {
  ...
  return (
    <section className="relative pt-20 pb-24 px-6 overflow-hidden">
      {/* Ambient glow */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[600px] bg-[var(--color-primary)]/8 rounded-full blur-[150px] pointer-events-none" />
      <div className="absolute bottom-0 right-0 w-[400px] h-[400px] bg-[var(--color-secondary)]/5 rounded-full blur-[100px] pointer-events-none" />

      <div className="max-w-5xl mx-auto text-center relative z-10">
        {/* Status Badge */}
        <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[var(--color-primary-dim)] border border-[var(--color-primary)]/20 mb-8">
          <span className="w-2 h-2 rounded-full bg-[var(--color-primary)] animate-pulse" />
          <span className="text-xs font-mono uppercase tracking-wider text-[var(--color-primary)]">Live on Solana Devnet</span>
        </div>
        ...
        <div className="flex flex-wrap justify-center gap-4 mb-12">
          <div className="flex items-center gap-2 px-4 py-2 rounded-lg bg-[var(--color-bg-surface-1)] border border-[var(--color-border)]">
            <svg className="w-4 h-4 text-[var(--color-primary)]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M13 10V3L4 14h7v7l9-11h-7z" />
            </svg>
            <span className="text-sm text-[var(--color-text-secondary)]">3s AI research</span>
          </div>
          <div className="flex items-center gap-2 px-4 py-2 rounded-lg bg-[var(--color-bg-surface-1)] border border-[var(--color-border)]">
            ...
            <span className="text-sm text-[var(--color-text-secondary)]">7%+ arbitrage detected</span>
          </div>
          <div className="flex items-center gap-2 px-4 py-2 rounded-lg bg-[var(--color-bg-surface-1)] border border-[var(--color-border)]">
            ...
            <span className="text-sm text-[var(--color-text-secondary)]">On-chain verified</span>
          </div>
        </div>
        ...
        <button
          onClick={login}
          className="inline-flex items-center gap-3 bg-[var(--color-primary)] hover:bg-[var(--color-primary-hover)] px-8 py-4 rounded-full transition-all font-bold text-lg text-[var(--color-bg-base)] cursor-pointer shadow-[var(--shadow-glow-primary-lg)] hover:shadow-[0_0_60px_var(--color-primary-glow)]"
        >
          <span>Start Predicting</span>
        ...
        <p className="mt-4 text-xs text-[var(--color-text-ghost)] font-mono">
      ...
      <div className="max-w-7xl mx-auto px-6 py-6">
        <div className="flex flex-wrap justify-center md:justify-between items-center gap-6 md:gap-4">
          <div className="flex items-center gap-3">
            <div className="w-6 h-6 rounded-full bg-gradient-to-tr from-[#9945FF] to-[#14F195]" />
            <span className="font-bold tracking-wide text-[var(--color-text-primary)]">SOLANA</span>
          </div>
          ...
          <div className="font-mono text-sm">
            ...
            <span className="text-[var(--color-text-ghost)] ml-1">2025 Volume</span>
          </div>
          <div className="h-4 w-px bg-[var(--color-border)] hidden md:block" />
          <div className="font-mono text-sm">
            <span className="text-[var(--color-primary)] font-bold">4x</span>
            <span className="text-[var(--color-text-ghost)] ml-1">YoY Growth</span>
          </div>
          <div className="h-4 w-px bg-[var(--color-border)] hidden md:block" />
          <div className="font-mono text-sm">
    ...
    <section className="py-24 px-6 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center mb-16">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-[var(--color-secondary-dim)] border border-[var(--color-secondary)]/20 mb-6">
            <span className="w-2 h-2 rounded-full bg-[var(--color-secondary)] animate-pulse" />
            <span className="text-xs font-mono uppercase tracking-wider text-[var(--color-secondary)]">Multi-Agent Intelligence</span>
          </div>
          <h2 className="text-4xl md:text-5xl font-black mb-4 text-[var(--color-text-primary)]">
        ...
        <div className="grid lg:grid-cols-2 gap-8 items-stretch">
          ...
          <div className="space-y-4">
            {agents.map((agent, index) => (
              <div
                key={agent.name}
                className={`relative rounded-2xl p-5 transition-all duration-500 cursor-pointer border ${
                  activeAgent === index
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      <span className="px-2 py-0.5 rounded text-[10px] font-mono" style={{ backgroundColor: `${agent.color}15`, color: agent.color }}>
                        {agent.model}
                      </span>
                      <span className="text-[10px] font-mono text-[var(--color-text-ghost)]">{agent.latency}</span>
                    </div>
                    <p className="text-sm text-[var(--color-text-muted)]">{agent.desc}</p>
                  </div>
            ...
            <div className="flex items-center justify-center gap-4 pt-4 border-t border-[var(--color-border)]">
              <span className="text-xs font-mono text-[var(--color-text-ghost)]">Powered by</span>
              <span className="text-sm font-semibold text-[var(--color-text-secondary)]">OpenClaw AI</span>
            </div>
          </div>

          {/* Right: Network Visualization */}
          <div className="relative h-[420px] bg-[var(--color-bg-surface-1)] rounded-2xl border border-[var(--color-border)] overflow-hidden">
            {/* Grid Background */}
    ...
    <section className="py-24 px-6 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center mb-12">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-[var(--color-primary-dim)] border border-[var(--color-primary)]/20 mb-6">
            <span className="w-2 h-2 rounded-full bg-[var(--color-primary)] animate-pulse" />
            <span className="text-xs font-mono uppercase tracking-wider text-[var(--color-primary)]">Experience the Edge</span>
          </div>
          <h2 className="text-4xl md:text-5xl font-black mb-4 text-[var(--color-text-primary)]">
        ...
        <div className="flex flex-wrap justify-center items-center gap-6 md:gap-10 mb-16">
          <span className="text-xs font-mono text-[var(--color-text-ghost)] uppercase tracking-wider">Aggregating from</span>
          {PLATFORMS.map((platform) => (
            <div
              key={platform.name}
              className="flex items-center gap-2 px-3 py-2 rounded-lg bg-[var(--color-bg-surface-1)] border border-[var(--color-border)] hover:border-[var(--color-border-hover)] transition-all cursor-pointer group"
            >
              <span style={{ color: platform.color }} className="opacity-70 group-hover:opacity-100 transition-opacity">
                {platform.logo}
              </span>
              <span className="text-sm font-medium text-[var(--color-text-muted)] group-hover:text-[var(--color-text-primary)] transition-colors hidden sm:inline">
                {platform.name}
              </span>
            </div>
          ))}
        ...
        <div className="flex justify-center">
          <div className="relative">
            {/* Glow behind card */}
            <div className="absolute inset-0 bg-[var(--color-primary)]/20 blur-[80px] rounded-full scale-75" />

            {/* Mock Swipe Card */}
            <div className="relative w-[340px] md:w-[380px] bg-[rgba(18,22,36,0.85)] backdrop-blur-xl rounded-[32px] border border-[var(--color-border)] shadow-2xl overflow-hidden">
              {/* Decorative glows */}
              ...
              <div className="relative p-6">
                ...
                <div className="flex items-center justify-between mb-4">
                  <span className="px-3 py-1 rounded-lg text-[11px] font-bold uppercase tracking-wide bg-[var(--color-gold)]/15 text-[var(--color-gold)] border border-[var(--color-gold)]/20">
                    CRYPTO
                  </span>
                  <div className="flex items-center gap-2 text-[10px] font-mono text-[var(--color-text-ghost)]">
                    <span className="w-1.5 h-1.5 rounded-full bg-[var(--color-primary)] animate-pulse" />
                    LIVE
                  </div>
                </div>
                ...
                {/* Question */}
                <h3 className="text-xl md:text-2xl font-bold text-[var(--color-text-primary)] leading-tight mb-6">
                ...
                {/* Stats */}
                <div className="grid grid-cols-2 gap-4 p-4 rounded-2xl bg-[rgba(0,0,0,0.3)] border border-[var(--color-border)] mb-6">
                  <div>
                    <div className="text-[11px] font-mono text-[var(--color-text-ghost)] uppercase mb-1">Yes Price</div>
                    <div className="text-2xl font-bold text-[var(--color-primary)]">34¢</div>
                  </div>
                  <div>
                    <div className="text-[11px] font-mono text-[var(--color-text-ghost)] uppercase mb-1">No Price</div>
                    <div className="text-2xl font-bold text-[var(--color-error)]">66¢</div>
                  </div>
                </div>

                {/* Footer */}
                <div className="flex items-center justify-between text-xs text-[var(--color-text-ghost)] border-t border-[var(--color-border)] pt-4">
                  <div className="flex items-center gap-1.5">
              ...
              {/* AI Insight Overlay */}
              <div
                className={`absolute bottom-0 left-0 right-0 bg-[var(--color-bg-surface-2)]/95 backdrop-blur-lg border-t border-[var(--color-secondary)]/30 p-5 transition-all duration-500 ${
              ...
              >
                ...
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center gap-2">
                    <div className="w-6 h-6 rounded-lg bg-[var(--color-secondary)]/20 flex items-center justify-center">
                      <svg className="w-4 h-4 text-[var(--color-secondary)]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" />
                      </svg>
                    </div>
                    <span className="text-xs font-bold uppercase tracking-wider text-[var(--color-secondary)]">AI Insight</span>
                  </div>
                  <span className="px-2 py-0.5 rounded text-[10px] font-bold uppercase bg-[var(--color-warning)]/15 text-[var(--color-warning)] border border-[var(--color-warning)]/20">
                    HIGH CONF
                  </span>
                </div>
                ...
                <div className="grid grid-cols-3 gap-3 mb-4">
                  <div className="text-center p-2 rounded-lg bg-[var(--color-bg-surface-1)]">
                    <div className="text-lg font-bold text-[var(--color-secondary)]">42%</div>
                    <div className="text-[10px] text-[var(--color-text-ghost)] uppercase">AI Est.</div>
                  </div>
                  <div className="text-center p-2 rounded-lg bg-[var(--color-bg-surface-1)]">
                    <div className="text-lg font-bold text-[var(--color-text-secondary)]">34%</div>
                    <div className="text-[10px] text-[var(--color-text-ghost)] uppercase">Market</div>
                  </div>
                  <div className="text-center p-2 rounded-lg bg-[var(--color-bg-surface-1)]">
                    <div className="text-lg font-bold text-[var(--color-primary)]">+8%</div>
                    <div className="text-[10px] text-[var(--color-text-ghost)] uppercase">Edge</div>
                  </div>
                </div>

                {/* Verdict */}
                <div className="flex items-start gap-2 p-3 rounded-xl bg-[var(--color-primary)]/10 border border-[var(--color-primary)]/20">
                  <span className="text-[var(--color-primary)] mt-0.5">→</span>
                  <p className="text-sm text-[var(--color-text-secondary)] leading-relaxed">
                    <span className="font-semibold text-[var(--color-text-primary)]">Underpriced YES.</span>{' '}
                    ETF inflows + halving cycle suggest higher probability than market implies.
                  </p>
                </div>
              </div>
            ...
            <div className="flex justify-center gap-12 mt-8">
              <button className="w-16 h-16 rounded-full bg-[var(--color-bg-surface-1)] border border-[var(--color-error)]/30 flex items-center justify-center text-[var(--color-error)] shadow-lg shadow-[var(--color-error)]/10 hover:scale-105 transition-transform cursor-pointer">
                <svg className="w-7 h-7" fill="none" stroke="currentColor" strokeWidth="2.5" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M6 18L18 6M6 6l12 12" />
                </svg>
              </button>
              <button className="w-16 h-16 rounded-full bg-[var(--color-bg-surface-1)] border border-[var(--color-primary)]/30 flex items-center justify-center text-[var(--color-primary)] shadow-lg shadow-[var(--color-primary)]/10 hover:scale-105 transition-transform cursor-pointer">
                <svg className="w-7 h-7" fill="none" stroke="currentColor" strokeWidth="2.5" viewBox="0 0 24 24">
            ...
            {/* Hint text */}
            <p className="text-center text-xs text-[var(--color-text-ghost)] mt-6 font-mono">
              ← SWIPE NO • SWIPE YES →
            </p>
          </div>
        </div>
...
function HowItWorksSection() {
  ...
  return (
    <section className="py-24 px-6 bg-[var(--color-bg-surface-1)]/30">
      <div className="max-w-5xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-black mb-4 text-[var(--color-text-primary)]">
            How It Works
          </h2>
          <p className="text-[var(--color-text-secondary)]">Three steps to the edge</p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {steps.map((step, i) => (
            <div
              key={step.num}
              className="relative group rounded-2xl bg-[var(--color-bg-surface-1)] border border-[var(--color-border)] p-8 text-center hover:border-[var(--color-border-hover)] transition-all cursor-pointer"
            >
              {/* Step Number */}
              <div
                className="absolute -top-4 left-1/2 -translate-x-1/2 w-8 h-8 rounded-full flex items-center justify-center text-xs font-bold font-mono"
    ...
    <section className="py-24 px-6">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-[var(--color-text-secondary)]">Everyone profits differently</p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {paths.map((path) => (
            <div
              key={path.title}
              className="group relative rounded-2xl bg-[var(--color-bg-surface-1)] border border-[var(--color-border)] p-8 hover:border-[var(--color-border-hover)] transition-all cursor-pointer overflow-hidden"
            >
              {/* Glow */}
              <div
                className="absolute top-0 right-0 w-32 h-32 rounded-full blur-[60px] opacity-0 group-hover:opacity-100 transition-opacity"
                style={{ backgroundColor: path.color }}
              />

              {/* Icon */}
              <div
                className="w-14 h-14 rounded-xl mb-6 flex items-center justify-center transition-transform group-hover:scale-110"
                style={{ backgroundColor: `${path.color}15`, border: `1px solid ${path.color}30`, color: path.color }}
              >
                {path.icon}
              </div>

              <h3 className="text-2xl font-bold mb-2 text-[var(--color-text-primary)]">{path.title}</h3>
              <p className="text-sm text-[var(--color-text-muted)] mb-6 leading-relaxed">{path.desc}</p>
...
function FinalCTASection() {
  ...
  return (
    <section className="py-24 relative overflow-hidden">
      {/* Ambient */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[700px] h-[700px] bg-gradient-radial from-[var(--color-primary)]/15 to-transparent rounded-full blur-[100px] pointer-events-none" />

      <div className="max-w-3xl mx-auto text-center relative z-10 px-6">
        <h2 className="text-5xl md:text-6xl lg:text-7xl font-black mb-6 text-[var(--color-text-primary)]">
          Ready to prove
          <br />
        ...
        <button
          onClick={login}
          className="inline-flex items-center gap-3 bg-[var(--color-primary)] hover:bg-[var(--color-primary-hover)] px-10 py-5 rounded-full transition-all font-bold text-lg text-[var(--color-bg-base)] cursor-pointer shadow-[var(--shadow-glow-primary-lg)]"
        >
          <span>Start Predicting</span>
          <svg className="w-5 h-5" fill="none" stroke="currentColor" strokeWidth="2.5" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" d="M17 8l4 4m0 0l-4 4m4-4H3" />
        ...
        <p className="mt-6 text-xs text-[var(--color-text-ghost)] font-mono">
        ...
        <div className="mt-16 flex items-center justify-center gap-3 opacity-50">
          <span className="text-xs font-mono text-[var(--color-text-ghost)]">POWERED BY</span>
          <span className="font-bold text-[var(--color-text-secondary)]">SOLANA</span>
        </div>
      </div>
    </section>
  );
