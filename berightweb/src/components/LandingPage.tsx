...
const VENUES = ['Polymarket', 'Limitless'];
      ...
      <div className={`${styles.wrap} ${styles.heroInner}`}>
        ...
        <div className={styles.heroLeft}>
          ...
          <h1 className={styles.heroTitle}>
            Get funded to Forecast on your Favorite venues
          </h1>

          <p className={styles.heroSub}>
            BeRight scores forecasters across Polymarket, Limitless, and native Solana forecasts. Qualified wallets can access transparent, read-only allocation workflows without giving up custody.
          </p>
