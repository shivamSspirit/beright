...
├─────────────────────────────────────────────────────────────┤
│  ┌──────────┐  ┌──────────┐  ┌──────────┐                   │
│  │Polymarket│  │Limitless │  │Metaculus │                   │
...
### 3. Limitless (On-chain Prediction Venue)
- **API**: Limitless public portfolio endpoints
...
Based on final composite score. Older pool/vault privilege labels are retired from active scope; current consumers should treat tiers as reputation/status bands.

| Tier | Score Range | Description | Active Meaning |
|------|-------------|-------------|----------------|
| 1 | 700+ | Elite | Highest reputation band |
| 2 | 600-699 | Expert | Strong reputation band |
| 3 | 500-599 | Verified | Verified skill |
| 4 | 300-499 | Average | Limited confidence |
| 5 | <300 | Unproven | No reputation privileges |
