...
1. **Ingests** prediction data from the currently implemented adapters (Polymarket, Limitless, and Metaculus)
...
- `VScore`: unified reputation score, kept as `vaultScore` in the current JSON/program contract for compatibility
...
│  • Native score (NScore)                │
│  • Unified reputation score (VScore)    │
└────────────────┬────────────────────────┘
                 ↓
┌─────────────────────────────────────────┐
│  JSON Outputs                           │
